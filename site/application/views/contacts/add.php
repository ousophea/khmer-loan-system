...
//                var address = "<?php // echo '<span>' . form_dropdown('txt_con_province', $arr_option_province, '', 'style="width:208px !important;" class="required22"') . '</span>';         ?>";
            ...
            <td><label for="lbl_con_kh_first_name_couple">Family Name in Khmer <span>*</span></label><input type="text" class="required2" placeholder="គោត្តនាម" name="txt_con_kh_first_name_couple"></td>\n\
<td><label for="lbl_con_kh_last_name_couple">Sure Name in Khmer <span>*</span></label><input type="text" class="required2" placeholder="នាម" name="txt_con_kh_last_name_couple"></td>\n\
...
<td><label for="lbl_con_en_first_name_couple">Family Name in English <span>*</span></label><input type="text" class="required2" value="" name="txt_con_en_first_name_couple"></td>\n\
<td><label for="lbl_con_en_last_name_couple">Sure Name in English <span>*</span></label><input type="text" class="required2" value="" name="txt_con_en_last_name_couple"></td>\n\
...
<td><label for="lbl_con_national_identity_card_couple">Identity Card / Passport<span>*</span></label><input type="text" value="" class="required2" name="txt_con_national_identity_card_couple"></td>\n\
