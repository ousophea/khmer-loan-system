...
echo form_open_multipart('loan/do_close_loan', array('class' => 'form-horizontal', 'name' => 'open_loan', 'id' => 'form_loan_approv'));
...
//        echo anchor('panel', 'Close Loan', 'class="btn btn-warning"');
        echo form_submit(array('name' => 'Close Loan', 'class' => 'btn btn-warning'), 'Close Loan');
        echo '</div></div>';
        ?>
        <div>
