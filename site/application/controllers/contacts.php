...
//            'contacts_job' => array('con_con_job_id' => 'con_job_id') //remove cos need for dropdown list
...
//                    $con_cids = $this->input->post('txt_con_cids'); // Use only for menul input for CID
                    ...
                    // contact detail infor
                    $get_con_det_pro_id = $this->input->post('txt_con_provience_group');
                    $get_con_det_dis_id = $this->input->post('txt_con_district_group');
                    $get_con_det_com_id = $this->input->post('txt_con_commune_group');
                    $get_con_det_vil_id = $this->input->post('txt_con_village_group');
...
//                            echo $last_id_contact_group; exit();
                            $arr_contact_detail_group = array(
                                ...
                                'con_det_vil_id' => $get_con_det_vil_id[$key]
                            );
                            $this->m_global->insert('contacts_detail', $arr_contact_detail_group);
                        }
                    }
                }
