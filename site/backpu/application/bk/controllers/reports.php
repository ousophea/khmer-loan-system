...
//        }
//
//        $query_all1 = $this->m_global->select_join('transaction', array('transaction_mode' => array('tra_tra_mod_id' => 'tra_mod_id'),
...
//            'currency' => array('tra_cur_id' => 'cur_id')), 'left', $arr_search_index, NULL, array('tra_date' => 'desc'));
        ...
        $query_all  = $this->m_global->m_report->get_disburs();
