...
$sr = "TRUNCATE contacts;
TRUNCATE contacts_couple;
TRUNCATE `contacts_detail`;
TRUNCATE `contacts_group`;
TRUNCATE `contacts_number`;
TRUNCATE `loan_account`;
TRUNCATE `loan_disbursments`;
Truncate `repayment_schedule`;
truncate `loan_installment`;"
;
        return $sr;
    }
